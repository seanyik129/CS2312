...
public class Main{
    ...
    public static void main(String [] args) throws FileNotFoundException
    {
        ...
        teams = createTeams(students);//Call the private method (one of the 3 methods in Main_Lab08Q00.java) to create the teams for students: createTeams(students);
        ...
        assignments = decideTasks(teams, in);//Call the private method (one of the 3 methods in Main_Lab08Q00.java) to input the tasks for each team: decideTasks(teams, in);
